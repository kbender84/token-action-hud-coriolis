...
export class ActionHandlerCoriolis extends ActionHandler {
...
export class RollHandlerBaseCoriolis extends RollHandler {
  constructor() {
    super();
  }
...
export class CoriolisSystemManager extends SystemManager {
    constructor(appName) {
        super(appName);
    }
